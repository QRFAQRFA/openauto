...
const uint32_t TableStruct_TouchEventData_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::f1x::aasdk::proto::data::TouchEvent, _has_bits_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, -1, sizeof(::f1x::aasdk::proto::data::TouchEvent)},
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_TouchEventData_2eproto = {
  false, false, 253, descriptor_table_protodef_TouchEventData_2eproto, "TouchEventData.proto", 
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::f1x::aasdk::proto::enums::TouchAction_Enum_IsValid(val))) {
...
// @@protoc_insertion_point(message_byte_size_start:f1x.aasdk.proto.data.TouchEvent)
  ...
  cached_has_bits = _has_bits_[0];
  if (cached_has_bits & 0x00000001u) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_action_index());
  }
...
bool TouchEvent::IsInitialized() const {
  ...
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(touch_location_))
    return false;
  return true;
}
