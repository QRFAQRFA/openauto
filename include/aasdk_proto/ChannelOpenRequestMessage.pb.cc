...
const uint32_t TableStruct_ChannelOpenRequestMessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::f1x::aasdk::proto::messages::ChannelOpenRequest, _has_bits_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 8, -1, sizeof(::f1x::aasdk::proto::messages::ChannelOpenRequest)},
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ChannelOpenRequestMessage_2eproto = {
  false, false, 119, descriptor_table_protodef_ChannelOpenRequestMessage_2eproto, "ChannelOpenRequestMessage.proto", 
