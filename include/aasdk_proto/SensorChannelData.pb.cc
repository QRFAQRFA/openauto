...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_SensorChannelData_2eproto = {
  false, false, 129, descriptor_table_protodef_SensorChannelData_2eproto, "SensorChannelData.proto", 
...
bool SensorChannel::IsInitialized() const {
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(sensors_))
    return false;
  return true;
}
