...
const uint32_t TableStruct_ButtonEventData_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::f1x::aasdk::proto::data::ButtonEvent, _has_bits_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 10, -1, sizeof(::f1x::aasdk::proto::data::ButtonEvent)},
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ButtonEventData_2eproto = {
  false, false, 133, descriptor_table_protodef_ButtonEventData_2eproto, "ButtonEventData.proto", 
...
// @@protoc_insertion_point(message_byte_size_start:f1x.aasdk.proto.data.ButtonEvent)
  ...
  cached_has_bits = _has_bits_[0];
  if (cached_has_bits & 0x00000002u) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_meta());
  }
