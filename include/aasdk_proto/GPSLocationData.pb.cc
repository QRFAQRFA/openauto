...
const uint32_t TableStruct_GPSLocationData_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::f1x::aasdk::proto::data::GPSLocation, _has_bits_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 13, -1, sizeof(::f1x::aasdk::proto::data::GPSLocation)},
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_GPSLocationData_2eproto = {
  false, false, 185, descriptor_table_protodef_GPSLocationData_2eproto, "GPSLocationData.proto", 
...
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:f1x.aasdk.proto.data.GPSLocation)
  ...
  if (_internal_has_accuracy()) {
    // required uint32 accuracy = 4;
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_accuracy());
  }
