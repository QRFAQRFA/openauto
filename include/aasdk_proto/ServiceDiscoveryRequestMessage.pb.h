...
inline std::string* ServiceDiscoveryRequest::release_device_brand() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = device_brand_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (device_brand_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
