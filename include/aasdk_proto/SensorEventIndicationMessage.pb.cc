...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_SensorEventIndicationMessage_2eproto = {
  false, false, 1408, descriptor_table_protodef_SensorEventIndicationMessage_2eproto, "SensorEventIndicationMessage.proto", 
...
bool SensorEventIndication::IsInitialized() const {
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(gps_location_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(compass_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(speed_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(rpm_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(odometer_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(fuel_level_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(parking_brake_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(gear_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(diagnostics_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(night_mode_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(enviorment_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(hvac_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(driving_status_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(steering_wheel_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(passenger_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(door_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(light_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(accel_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(gyro_))
    return false;
  return true;
}
