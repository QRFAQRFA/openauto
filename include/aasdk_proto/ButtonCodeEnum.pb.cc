...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ButtonCodeEnum_2eproto = {
  false, false, 434, descriptor_table_protodef_ButtonCodeEnum_2eproto, "ButtonCodeEnum.proto", 
