...
const uint32_t TableStruct_AVInputOpenRequestMessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::f1x::aasdk::proto::messages::AVInputOpenRequest, _has_bits_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 10, -1, sizeof(::f1x::aasdk::proto::messages::AVInputOpenRequest)},
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_AVInputOpenRequestMessage_2eproto = {
  false, false, 141, descriptor_table_protodef_AVInputOpenRequestMessage_2eproto, "AVInputOpenRequestMessage.proto", 
...
// @@protoc_insertion_point(message_byte_size_start:f1x.aasdk.proto.messages.AVInputOpenRequest)
  ...
  if (cached_has_bits & 0x0000000eu) {
    ...
    // optional int32 max_unacked = 4;
    if (cached_has_bits & 0x00000008u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_max_unacked());
    }
