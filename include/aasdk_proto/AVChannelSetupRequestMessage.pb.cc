...
const uint32_t TableStruct_AVChannelSetupRequestMessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::f1x::aasdk::proto::messages::AVChannelSetupRequest, _has_bits_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 7, -1, sizeof(::f1x::aasdk::proto::messages::AVChannelSetupRequest)},
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_AVChannelSetupRequestMessage_2eproto = {
  false, false, 109, descriptor_table_protodef_AVChannelSetupRequestMessage_2eproto, "AVChannelSetupRequestMessage.proto", 
...
// @@protoc_insertion_point(message_byte_size_start:f1x.aasdk.proto.messages.AVChannelSetupRequest)
  ...
  if (_internal_has_config_index()) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_config_index());
  }
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
