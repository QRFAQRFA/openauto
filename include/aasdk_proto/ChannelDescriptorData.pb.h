...
class ChannelDescriptor final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::f1x::aasdk::proto::data::MediaInfoChannel* release_media_infochannel();
  ...
  ::f1x::aasdk::proto::data::MediaInfoChannel* _internal_mutable_media_infochannel();
  public:
  void unsafe_arena_set_allocated_media_infochannel(
      ::f1x::aasdk::proto::data::MediaInfoChannel* media_infochannel);
  ::f1x::aasdk::proto::data::MediaInfoChannel* unsafe_arena_release_media_infochannel();
...
inline const ::f1x::aasdk::proto::data::MediaInfoChannel& ChannelDescriptor::_internal_media_infochannel() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::f1x::aasdk::proto::data::MediaInfoChannel&>(
...
inline void ChannelDescriptor::unsafe_arena_set_allocated_media_infochannel(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:f1x.aasdk.proto.data.ChannelDescriptor.media_infoChannel)
}
...
inline ::f1x::aasdk::proto::data::MediaInfoChannel* ChannelDescriptor::unsafe_arena_release_media_infochannel() {
...
inline ::f1x::aasdk::proto::data::MediaInfoChannel* ChannelDescriptor::_internal_mutable_media_infochannel() {
  _has_bits_[0] |= 0x00000020u;
  if (media_infochannel_ == nullptr) {
    auto* p = CreateMaybeMessage<::f1x::aasdk::proto::data::MediaInfoChannel>(GetArenaForAllocation());
...
inline ::f1x::aasdk::proto::data::MediaInfoChannel* ChannelDescriptor::mutable_media_infochannel() {
  ::f1x::aasdk::proto::data::MediaInfoChannel* _msg = _internal_mutable_media_infochannel();
